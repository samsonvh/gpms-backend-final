...
namespace GPMS.Backend.Data.Migrations
{
    ...
    [Migration("20240716065523_Make DepartmentID in Staff Null")]
    partial class MakeDepartmentIDinStaffNull
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GPMS.Backend.Data.Models.ProductionPlans.ProductionPlan", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 7, 16, 6, 55, 20, 85, DateTimeKind.Utc).AddTicks(6231));
            ...
            modelBuilder.Entity("GPMS.Backend.Data.Models.Products.Product", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 7, 16, 6, 55, 20, 73, DateTimeKind.Utc).AddTicks(8035));
            ...
            modelBuilder.Entity("GPMS.Backend.Data.Models.Requests.InspectionRequest", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 7, 16, 6, 55, 20, 63, DateTimeKind.Utc).AddTicks(8062));
            ...
            modelBuilder.Entity("GPMS.Backend.Data.Models.Requests.WarehouseRequest", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 7, 16, 6, 55, 20, 119, DateTimeKind.Utc).AddTicks(1875));
            ...
            modelBuilder.Entity("GPMS.Backend.Data.Models.Results.FaultyProduct", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 7, 16, 6, 55, 20, 62, DateTimeKind.Utc).AddTicks(4974));
            ...
            modelBuilder.Entity("GPMS.Backend.Data.Models.Results.InspectionRequestResult", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 7, 16, 6, 55, 20, 71, DateTimeKind.Utc).AddTicks(3619));
            ...
            modelBuilder.Entity("GPMS.Backend.Data.Models.Results.ProductionProcessStepResult", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 7, 16, 6, 55, 20, 104, DateTimeKind.Utc).AddTicks(6401));
            ...
            modelBuilder.Entity("GPMS.Backend.Data.Models.Staffs.Account", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 7, 16, 6, 55, 20, 59, DateTimeKind.Utc).AddTicks(4306));
            ...
            modelBuilder.Entity("GPMS.Backend.Data.Models.Warehouses.WarehouseTicket", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 7, 16, 6, 55, 20, 140, DateTimeKind.Utc).AddTicks(2185));
