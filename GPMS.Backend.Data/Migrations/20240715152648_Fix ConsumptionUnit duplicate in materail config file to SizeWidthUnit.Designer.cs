...
namespace GPMS.Backend.Data.Migrations
{
    ...
    [Migration("20240715152648_Fix ConsumptionUnit duplicate in materail config file to SizeWidthUnit")]
    partial class FixConsumptionUnitduplicateinmaterailconfigfiletoSizeWidthUnit
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GPMS.Backend.Data.Models.ProductionPlans.ProductionPlan", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 7, 15, 15, 26, 47, 359, DateTimeKind.Utc).AddTicks(6312));
            ...
            modelBuilder.Entity("GPMS.Backend.Data.Models.Products.Product", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 7, 15, 15, 26, 47, 346, DateTimeKind.Utc).AddTicks(1395));
            ...
            modelBuilder.Entity("GPMS.Backend.Data.Models.Requests.InspectionRequest", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 7, 15, 15, 26, 47, 326, DateTimeKind.Utc).AddTicks(6499));
            ...
            modelBuilder.Entity("GPMS.Backend.Data.Models.Requests.WarehouseRequest", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 7, 15, 15, 26, 47, 402, DateTimeKind.Utc).AddTicks(917));
            ...
            modelBuilder.Entity("GPMS.Backend.Data.Models.Results.FaultyProduct", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 7, 15, 15, 26, 47, 323, DateTimeKind.Utc).AddTicks(7190));
            ...
            modelBuilder.Entity("GPMS.Backend.Data.Models.Results.InspectionRequestResult", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 7, 15, 15, 26, 47, 336, DateTimeKind.Utc).AddTicks(5954));
            ...
            modelBuilder.Entity("GPMS.Backend.Data.Models.Results.ProductionProcessStepResult", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 7, 15, 15, 26, 47, 381, DateTimeKind.Utc).AddTicks(2529));
            ...
            modelBuilder.Entity("GPMS.Backend.Data.Models.Staffs.Account", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 7, 15, 15, 26, 47, 309, DateTimeKind.Utc).AddTicks(6795));
            ...
            modelBuilder.Entity("GPMS.Backend.Data.Models.Warehouses.WarehouseTicket", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 7, 15, 15, 26, 47, 410, DateTimeKind.Utc).AddTicks(9463));
